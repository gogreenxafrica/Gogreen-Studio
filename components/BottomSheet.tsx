    ...
    <AnimatePresence>
      ...
      {isOpen && (
        <motion.div
          ...
          className={`fixed bottom-0 left-0 right-0 z-50 bg-white rounded-t-[40px] md:rounded-[40px] overflow-hidden shadow-2xl flex flex-col mx-auto md:bottom-10 md:left-1/2 md:-translate-x-1/2 lg:max-w-[480px] md:max-w-[540px] ${fullHeight ? 'h-[92vh] md:h-[80vh]' : 'max-h-[92vh] md:max-h-[85vh]'}`}
