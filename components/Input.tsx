...
export const Input = ({
  ...
  const variantStyles = {
    default: `bg-gray-50 border-gray-200 focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 text-gray-900 placeholder:text-gray-400 shadow-sm ${error ? 'border-red-500 focus:border-red-500 focus:ring-red-500/10' : ''}`,
    glass: `bg-white/5 backdrop-blur-xl border-white/10 focus:bg-white/10 focus:border-primary focus:ring-4 focus:ring-primary/20 text-white placeholder:text-white/40 shadow-sm ${error ? 'border-red-500 focus:border-red-500 focus:ring-red-500/20' : ''}`,
    'glass-light': `bg-gray-50 border-gray-200 focus:bg-white focus:border-primary focus:ring-4 focus:ring-primary/10 text-gray-900 placeholder:text-gray-400 shadow-sm ${error ? 'border-red-500 focus:border-red-500 focus:ring-red-500/10' : ''}`
  };
  ...
  return (
    <div className={`flex flex-col gap-1.5 ${className}`}>
      ...
      {error && (
        <p className="text-[10px] font-bold text-red-500 ml-1 mt-0.5 animate-shake">
          {error}
        </p>
      )}
    </div>
