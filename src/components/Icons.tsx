...
import { 
  ...
  MoreHorizontal, ShoppingBag, MessageCircle, Paperclip, Download, Home, Grid, Scan, Wallet, Gift, MessageSquare, Gamepad, Gamepad2,
  Search, Filter, ArrowLeft, ArrowDown, Play, GraduationCap, Mail, Facebook, Instagram, Twitter, ChevronDown, Send,
  CheckCircle, Activity, Fingerprint, Camera, Moon, ArrowUpRight, RefreshCw, Users
} from 'lucide-react';
...
export const Icons: any = {
  ...
  Bank: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M3 21h18M5 21v-7M19 21v-7M4 10h16v4h-16zM2 10l10-7 10 7M9 21v-7M15 21v-7" />
    </svg>
  ),
  ...
  Bulb: (props: React.SVGProps<SVGSVGElement>) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M9 18h6" />
      <path d="M10 22h4" />
      <path d="M15.09 14c.18-.9.66-1.68 1.41-2.19A6 6 0 1 0 7.5 11.81c.75.51 1.23 1.29 1.41 2.19" />
    </svg>
  ),
