...
export const SendScreen: React.FC<SendScreenProps> = ({
    ...
    return (
      <div className="flex-1 flex flex-col bg-green-50/30 animate-fade-in items-center w-full h-full overflow-hidden min-h-0">
        <div className="w-full flex flex-col flex-1 min-h-0">
          {!isModal && <BackHeader title="Send Crypto" subtitle="Select Asset" onBack={goBack} />}
          
          {isModal && (
            <div className="px-6 pt-8 pb-4 flex justify-between items-center">
              <div>
                <h2 className="text-xl font-black text-gray-900 tracking-tight">Send Crypto</h2>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Select Asset</p>
              </div>
  ...
  const renderRecipient = () => {
    return (
      <div className="flex-1 flex flex-col bg-green-50/30 animate-fade-in items-center w-full h-full overflow-hidden min-h-0">
        <div className="w-full flex flex-col flex-1 min-h-0">
          {!isModal && <BackHeader title={`Send ${sendAsset?.symbol}`} subtitle="Recipient Details" onBack={() => setScreen(AppScreen.SEND_SELECT_ASSET)} />}
          
          {isModal && (
            <div className="px-6 pt-8 pb-4 flex justify-between items-center">
              <div>
                <h2 className="text-xl font-black text-gray-900 tracking-tight">{`Send ${sendAsset?.symbol}`}</h2>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Recipient Details</p>
              </div>
              <button onClick={() => setScreen(AppScreen.SEND_SELECT_ASSET)} className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500">
                <Icons.X className="w-5 h-5" />
              </button>
            </div>
          )}
  ...
  const renderAmount = () => {
    ...
    return (
      <div className="flex-1 flex flex-col bg-green-50/30 animate-fade-in items-center w-full h-full overflow-hidden min-h-0">
        <div className="w-full flex flex-col flex-1 min-h-0">
          {!isModal && <BackHeader title="Send Crypto" subtitle="Enter Amount" onBack={() => setScreen(AppScreen.SEND_RECIPIENT)} />}
          
          {isModal && (
            <div className="px-6 pt-8 pb-4 flex justify-between items-center">
              <div>
                <h2 className="text-xl font-black text-gray-900 tracking-tight">Send Crypto</h2>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Enter Amount</p>
              </div>
              <button onClick={() => setScreen(AppScreen.SEND_RECIPIENT)} className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500">
                <Icons.X className="w-5 h-5" />
              </button>
            </div>
          )}
    ...
    return (
      <div className="flex-1 flex flex-col bg-green-50/30 animate-fade-in items-center relative overflow-hidden w-full h-full min-h-0">
        <div className="w-full flex flex-col flex-1 min-h-0 relative z-10">
          {!isModal && <BackHeader title="Confirm Send" subtitle="Review Details" onBack={() => setScreen(AppScreen.SEND_AMOUNT)} />}
          
          {isModal && (
            <div className="px-6 pt-8 pb-4 flex justify-between items-center">
              <div>
                <h2 className="text-xl font-black text-gray-900 tracking-tight">Confirm Send</h2>
                <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em] mt-1">Review Details</p>
              </div>
              <button onClick={() => setScreen(AppScreen.SEND_AMOUNT)} className="w-10 h-10 rounded-full bg-gray-100 flex items-center justify-center text-gray-500">
                <Icons.X className="w-5 h-5" />
              </button>
            </div>
          )}
                        ...
                        if (isSuccess) {
                          ...
                          if (saveBeneficiary) {
                            const newBeneficiary = {
                              ...
                              network: sendRecipientType === 'address' ? selectedNetwork : undefined,
                              fullAddress: sendRecipientType === 'address' ? sendRecipient : undefined
                            };
        ...
        <div className="flex-1 flex flex-col bg-green-50/30 items-center animate-fade-in relative overflow-hidden w-full h-full min-h-0">
           ...
           <div className="w-full bg-primary pt-12 pb-20 px-6 text-center relative overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/70 text-[11px] font-black uppercase tracking-[0.2em]">Transaction ID: SND-{Math.random().toString(36).substring(2, 10).toUpperCase()}</p>
              </div>
           </div>
               ...
               <div className="bg-white rounded-[40px] p-6 shadow-2xl shadow-gray-200/60 border border-gray-100 relative overflow-hidden">
                  ...
                  <div className="space-y-4 relative z-10">
                    <div className="flex justify-between items-center py-4 border-b border-gray-50">
                      ...
                      <div className="text-right">
                        <p className="font-black text-gray-900 text-sm truncate max-w-[180px]">{sendRecipient}</p>
                        <p className="text-[9px] font-black text-primary uppercase tracking-widest mt-0.5">{sendRecipientType.replace('_', ' ')}</p>
                      </div>
                    </div>
                  ...
                  <div className="mt-10 space-y-3 relative z-10 flex flex-col items-center">
                    <Button variant="primary" onClick={() => { setScreen(AppScreen.HOME); setSendAmount(''); }} className="px-12 !h-14 !rounded-[24px] !bg-primary shadow-xl shadow-primary/20 !text-xs font-black uppercase tracking-[0.2em]">Back to Dashboard</Button>
  ...
  const renderDestination = () => {
    ...
    return (
      <div className="flex-1 flex flex-col bg-green-50/30 animate-fade-in items-center w-full h-full overflow-hidden min-h-0">
        <div className="w-full flex flex-col flex-1 min-h-0">
          <BackHeader title="Send money" onBack={goBack} />
